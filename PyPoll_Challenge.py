...
file_to_save = os.path.join("..","Election_Anaysis", "election_analysis_final.txt")
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county_vote_count > winning_county_count) and ( county_percentage> winning_county_percentage):
